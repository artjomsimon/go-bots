...
// TODO: package like BOTS: package nqueens
package main
...
//func (cmplx COMPLEX) re()

/*
 * compute the W coefficients (that is, powers of the root of 1)
 * and store them into an array.
 */
func compute_w_coefficients(n int, a int, b int, W []COMPLEX) {
     var twoPiOverN float64
     var s, c float64
...
func compute_w_coefficients_seq(n int, a int, b int, W *complex128) {
     var twoPiOverN float64
     var s, c float64
...
func unshuffle(a int, b int, in []complex128, out []complex128, r int, m int) {
	r4 := r & (^0x3)
     const COMPLEX *ip
     COMPLEX *jp
...
func unshuffle_seq(a int, b int, in *complex128, out *complex128, r int, m int) {
	r4 := r & (^0x3)
     const COMPLEX *ip
     COMPLEX *jp
...
func fft_twiddle_gen1(in []COMPLEX, out []COMPLEX,
				  W []COMPLEX, r int, m int,
				  nW int, nWdnti int, nWdntm int) {

	// kp = out
	 for k := 0; k < r; k++ {
	  var r0, i0, rt, it, rw, iw float64
	  l1 := nWdnti + nWdntm * k
...
func fft_twiddle_gen(i int, i1 int, in []complex128, out []complex128, W []complex128, nW int, nWdn int, r int, m int) {
     if (i == i1 - 1) {
          //#pragma omp task untied
...
func fft_twiddle_gen_seq(i int, i1 int, in []complex128, out []complex128, W []complex128,
                         nW int, nWdn int, r int, m int) {
     if (i == i1 - 1) {
	  fft_twiddle_gen1(in + i, out + i, W,
				 r, m, nW, nWdn * i, nWdn * m)
     } else {
...
func fft_base_2(in []complex128, out []complex128) {
     var r1_0, i1_0 float64
     var r1_1, i1_1 float64
     r1_0 = c_re(in[0])
     i1_0 = c_im(in[0])
     r1_1 = c_re(in[1])
     i1_1 = c_im(in[1])
...
func fft_twiddle_2(a int, b int, in []complex128, out []complex128, W []complex128, nW int, nWdn int, m int) {
     var  tmpr, tmpi, wr, wi float64
     if ((b - a) < 128) {
		 // kp = out + i
		 for i, l1 := a, nWdn * i; i < b; i, l1 = i+1, l1 + nWdn {
	       jp = in + i;
	       {
		    var  r1_0, i1_0 float64
		    var  r1_1, i1_1 float64
...
func fft_twiddle_2_seq(a int, b int, in []complex128, out []complex128, W []complex128, nW int, nWdn int, m int) {
     COMPLEX *jp, *kp;
     var tmpr, tmpi, wr, wi float64
     if ((b - a) < 128) {
		 for i,l1 := a, nWdn * i, kp = out + i; i < b;
	       i++, l1 += nWdn, kp++) {
	       jp = in + i;
	       {
		    var  r1_0, i1_0 float64
...
func fft_unshuffle_2(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_unshuffle_2_seq(a int, b int, in *complex128, out *complex128, m int) {
     const COMPLEX *ip;
     COMPLEX *jp;
     if ((b - a) < 128) {
	  ip = in + a * 2;
...
func fft_base_4(COMPLEX * in, COMPLEX * out)
{
     var  r1_0, i1_0 float64
     var  r1_1, i1_1 float64
     var  r1_2, i1_2 float64
     var  r1_3, i1_3 float64
     {
	  var  r2_0, i2_0 float64
	  var  r2_2, i2_2 float64
	  r2_0 = c_re(in[0])
	  i2_0 = c_im(in[0])
	  r2_2 = c_re(in[2])
	  i2_2 = c_im(in[2])
     ...
     {
	  var  r2_1, i2_1 float64
	  var  r2_3, i2_3 float64
	  r2_1 = c_re(in[1])
	  i2_1 = c_im(in[1])
	  r2_3 = c_re(in[3])
	  i2_3 = c_im(in[3])
...
func fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_twiddle_4_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_unshuffle_4(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_unshuffle_4_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_base_8(COMPLEX * in, COMPLEX * out)
{
     var  tmpr, tmpi float64
     {
	  var  r1_0, i1_0 float64
	  var  r1_1, i1_1 float64
	  var  r1_2, i1_2 float64
	  var  r1_3, i1_3 float64
	  var  r1_4, i1_4 float64
	  var  r1_5, i1_5 float64
	  var  r1_6, i1_6 float64
	  var  r1_7, i1_7 float64
	  {
	       var  r2_0, i2_0 float64
	       var  r2_2, i2_2 float64
	       var  r2_4, i2_4 float64
	       var  r2_6, i2_6 float64
	       {
		    var  r3_0, i3_0 float64
		    var  r3_4, i3_4 float64
		    r3_0 = c_re(in[0])
		    i3_0 = c_im(in[0])
		    r3_4 = c_re(in[4])
		    i3_4 = c_im(in[4])
	       ...
	       {
		    var  r3_2, i3_2 float64
		    var  r3_6, i3_6 float64
		    r3_2 = c_re(in[2])
		    i3_2 = c_im(in[2])
		    r3_6 = c_re(in[6])
		    i3_6 = c_im(in[6])
	  ...
	  }
	  {
	       var  r2_1, i2_1 float64
	       var  r2_3, i2_3 float64
	       var  r2_5, i2_5 float64
	       var  r2_7, i2_7 float64
	       {
		    var  r3_1, i3_1 float64
		    var  r3_5, i3_5 float64
		    r3_1 = c_re(in[1])
		    i3_1 = c_im(in[1])
		    r3_5 = c_re(in[5])
		    i3_5 = c_im(in[5])
	       ...
	       {
		    var  r3_3, i3_3 float64
		    var  r3_7, i3_7 float64
		    r3_3 = c_re(in[3])
		    i3_3 = c_im(in[3])
		    r3_7 = c_re(in[7])
		    i3_7 = c_im(in[7])
...
func fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_twiddle_8_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_unshuffle_8(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_unshuffle_8_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_base_16(COMPLEX * in, COMPLEX * out)
{
     var  tmpr, tmpi float64
     {
	  var  r1_0, i1_0 float64
	  ...
	  var  r1_6, i1_6 float64
	  var  r1_7, i1_7 float64
	  var  r1_8, i1_8 float64
	  var  r1_9, i1_9 float64
	  var  r1_10, i1_10 float64
	  var  r1_11, i1_11 float64
	  var  r1_12, i1_12 float64
	  var  r1_13, i1_13 float64
	  var  r1_14, i1_14 float64
	  var  r1_15, i1_15 float64
	  {
	       var  r2_0, i2_0 float64
	       var  r2_2, i2_2 float64
	       var  r2_4, i2_4 float64
	       var  r2_6, i2_6 float64
	       var  r2_8, i2_8 float64
	       var  r2_10, i2_10 float64
	       var  r2_12, i2_12 float64
	       var  r2_14, i2_14 float64
	       {
		    var  r3_0, i3_0 float64
		    var  r3_4, i3_4 float64
		    var  r3_8, i3_8 float64
		    var  r3_12, i3_12 float64
		    {
			 var  r4_0, i4_0 float64
			 var  r4_8, i4_8 float64
			 r4_0 = c_re(in[0])
			 i4_0 = c_im(in[0])
			 r4_8 = c_re(in[8])
			 i4_8 = c_im(in[8])
		    ...
		    {
			 var  r4_4, i4_4 float64
			 var  r4_12, i4_12 float64
			 r4_4 = c_re(in[4])
			 i4_4 = c_im(in[4])
			 r4_12 = c_re(in[12])
			 i4_12 = c_im(in[12])
	       ...
	       }
	       {
		    var  r3_2, i3_2 float64
		    var  r3_6, i3_6 float64
		    var  r3_10, i3_10 float64
		    var  r3_14, i3_14 float64
		    {
			 var  r4_2, i4_2 float64
			 var  r4_10, i4_10 float64
			 r4_2 = c_re(in[2])
			 i4_2 = c_im(in[2])
			 r4_10 = c_re(in[10])
			 i4_10 = c_im(in[10])
		    ...
		    {
			 var  r4_6, i4_6 float64
			 var  r4_14, i4_14 float64
			 r4_6 = c_re(in[6])
			 i4_6 = c_im(in[6])
			 r4_14 = c_re(in[14])
			 i4_14 = c_im(in[14])
	  ...
	  }
	  {
	       ...
	       var  r2_5, i2_5 float64
	       var  r2_7, i2_7 float64
	       var  r2_9, i2_9 float64
	       var  r2_11, i2_11 float64
	       var  r2_13, i2_13 float64
	       var  r2_15, i2_15 float64
	       {
		    var  r3_1, i3_1 float64
		    var  r3_5, i3_5 float64
		    var  r3_9, i3_9 float64
		    var  r3_13, i3_13 float64
		    {
			 var  r4_1, i4_1 float64
			 var  r4_9, i4_9 float64
			 r4_1 = c_re(in[1])
			 i4_1 = c_im(in[1])
			 r4_9 = c_re(in[9])
			 i4_9 = c_im(in[9])
		    ...
		    {
			 var  r4_5, i4_5 float64
			 var  r4_13, i4_13 float64
			 r4_5 = c_re(in[5])
			 i4_5 = c_im(in[5])
			 r4_13 = c_re(in[13])
			 i4_13 = c_im(in[13])
	       ...
	       }
	       {
		    var  r3_3, i3_3 float64
		    var  r3_7, i3_7 float64
		    var  r3_11, i3_11 float64
		    var  r3_15, i3_15 float64
		    {
			 var  r4_3, i4_3 float64
			 var  r4_11, i4_11 float64
			 r4_3 = c_re(in[3])
			 i4_3 = c_im(in[3])
			 r4_11 = c_re(in[11])
			 i4_11 = c_im(in[11])
		    ...
		    {
			 var  r4_7, i4_7 float64
			 var  r4_15, i4_15 float64
			 r4_7 = c_re(in[7])
			 i4_7 = c_im(in[7])
			 r4_15 = c_re(in[15])
			 i4_15 = c_im(in[15])
...
func fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_twiddle_16_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_unshuffle_16(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_unshuffle_16_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_base_32(COMPLEX * in, COMPLEX * out)
{
     var  tmpr, tmpi float64
     {
	  var  r1_0, i1_0 float64
	  ...
	  var  r1_14, i1_14 float64
	  var  r1_15, i1_15 float64
	  var  r1_16, i1_16 float64
	  var  r1_17, i1_17 float64
	  var  r1_18, i1_18 float64
	  var  r1_19, i1_19 float64
	  var  r1_20, i1_20 float64
	  var  r1_21, i1_21 float64
	  var  r1_22, i1_22 float64
	  var  r1_23, i1_23 float64
	  var  r1_24, i1_24 float64
	  var  r1_25, i1_25 float64
	  var  r1_26, i1_26 float64
	  var  r1_27, i1_27 float64
	  var  r1_28, i1_28 float64
	  var  r1_29, i1_29 float64
	  var  r1_30, i1_30 float64
	  var  r1_31, i1_31 float64
	  {
	       var  r2_0, i2_0 float64
	       var  r2_2, i2_2 float64
	       var  r2_4, i2_4 float64
	       ...
	       var  r2_12, i2_12 float64
	       var  r2_14, i2_14 float64
	       var  r2_16, i2_16 float64
	       var  r2_18, i2_18 float64
	       var  r2_20, i2_20 float64
	       var  r2_22, i2_22 float64
	       var  r2_24, i2_24 float64
	       var  r2_26, i2_26 float64
	       var  r2_28, i2_28 float64
	       var  r2_30, i2_30 float64
	       {
		    var  r3_0, i3_0 float64
		    var  r3_4, i3_4 float64
		    var  r3_8, i3_8 float64
		    var  r3_12, i3_12 float64
		    var  r3_16, i3_16 float64
		    var  r3_20, i3_20 float64
		    var  r3_24, i3_24 float64
		    var  r3_28, i3_28 float64
		    {
			 var  r4_0, i4_0 float64
			 var  r4_8, i4_8 float64
			 var  r4_16, i4_16 float64
			 var  r4_24, i4_24 float64
			 {
			      var  r5_0, i5_0 float64
			      var  r5_16, i5_16 float64
			      r5_0 = c_re(in[0])
			      i5_0 = c_im(in[0])
			      r5_16 = c_re(in[16])
			      i5_16 = c_im(in[16])
			 ...
			 {
			      var  r5_8, i5_8 float64
			      var  r5_24, i5_24 float64
			      r5_8 = c_re(in[8])
			      i5_8 = c_im(in[8])
			      r5_24 = c_re(in[24])
			      i5_24 = c_im(in[24])
		    ...
		    }
		    {
			 var  r4_4, i4_4 float64
			 var  r4_12, i4_12 float64
			 var  r4_20, i4_20 float64
			 var  r4_28, i4_28 float64
			 {
			      var  r5_4, i5_4 float64
			      var  r5_20, i5_20 float64
			      r5_4 = c_re(in[4])
			      i5_4 = c_im(in[4])
			      r5_20 = c_re(in[20])
			      i5_20 = c_im(in[20])
			 ...
			 {
			      var  r5_12, i5_12 float64
			      var  r5_28, i5_28 float64
			      r5_12 = c_re(in[12])
			      i5_12 = c_im(in[12])
			      r5_28 = c_re(in[28])
			      i5_28 = c_im(in[28])
	       ...
	       }
	       {
		    ...
		    var  r3_10, i3_10 float64
		    var  r3_14, i3_14 float64
		    var  r3_18, i3_18 float64
		    var  r3_22, i3_22 float64
		    var  r3_26, i3_26 float64
		    var  r3_30, i3_30 float64
		    {
			 var  r4_2, i4_2 float64
			 var  r4_10, i4_10 float64
			 var  r4_18, i4_18 float64
			 var  r4_26, i4_26 float64
			 {
			      var  r5_2, i5_2 float64
			      var  r5_18, i5_18 float64
			      r5_2 = c_re(in[2])
			      i5_2 = c_im(in[2])
			      r5_18 = c_re(in[18])
			      i5_18 = c_im(in[18])
			 ...
			 {
			      var  r5_10, i5_10 float64
			      var  r5_26, i5_26 float64
			      r5_10 = c_re(in[10])
			      i5_10 = c_im(in[10])
			      r5_26 = c_re(in[26])
			      i5_26 = c_im(in[26])
		    ...
		    }
		    {
			 var  r4_6, i4_6 float64
			 var  r4_14, i4_14 float64
			 var  r4_22, i4_22 float64
			 var  r4_30, i4_30 float64
			 {
			      var  r5_6, i5_6 float64
			      var  r5_22, i5_22 float64
			      r5_6 = c_re(in[6])
			      i5_6 = c_im(in[6])
			      r5_22 = c_re(in[22])
			      i5_22 = c_im(in[22])
			 ...
			 {
			      var  r5_14, i5_14 float64
			      var  r5_30, i5_30 float64
			      r5_14 = c_re(in[14])
			      i5_14 = c_im(in[14])
			      r5_30 = c_re(in[30])
			      i5_30 = c_im(in[30])
	  ...
	  }
	  {
	       ...
	       var  r2_13, i2_13 float64
	       var  r2_15, i2_15 float64
	       var  r2_17, i2_17 float64
	       var  r2_19, i2_19 float64
	       var  r2_21, i2_21 float64
	       var  r2_23, i2_23 float64
	       var  r2_25, i2_25 float64
	       var  r2_27, i2_27 float64
	       var  r2_29, i2_29 float64
	       var  r2_31, i2_31 float64
	       {
		    var  r3_1, i3_1 float64
		    var  r3_5, i3_5 float64
		    var  r3_9, i3_9 float64
		    var  r3_13, i3_13 float64
		    var  r3_17, i3_17 float64
		    var  r3_21, i3_21 float64
		    var  r3_25, i3_25 float64
		    var  r3_29, i3_29 float64
		    {
			 var  r4_1, i4_1 float64
			 var  r4_9, i4_9 float64
			 var  r4_17, i4_17 float64
			 var  r4_25, i4_25 float64
			 {
			      var  r5_1, i5_1 float64
			      var  r5_17, i5_17 float64
			      r5_1 = c_re(in[1])
			      i5_1 = c_im(in[1])
			      r5_17 = c_re(in[17])
			      i5_17 = c_im(in[17])
			 ...
			 {
			      var  r5_9, i5_9 float64
			      var  r5_25, i5_25 float64
			      r5_9 = c_re(in[9])
			      i5_9 = c_im(in[9])
			      r5_25 = c_re(in[25])
			      i5_25 = c_im(in[25])
		    ...
		    }
		    {
			 var  r4_5, i4_5 float64
			 var  r4_13, i4_13 float64
			 var  r4_21, i4_21 float64
			 var  r4_29, i4_29 float64
			 {
			      var  r5_5, i5_5 float64
			      var  r5_21, i5_21 float64
			      r5_5 = c_re(in[5])
			      i5_5 = c_im(in[5])
			      r5_21 = c_re(in[21])
			      i5_21 = c_im(in[21])
			 ...
			 {
			      var  r5_13, i5_13 float64
			      var  r5_29, i5_29 float64
			      r5_13 = c_re(in[13])
			      i5_13 = c_im(in[13])
			      r5_29 = c_re(in[29])
			      i5_29 = c_im(in[29])
	       ...
	       }
	       {
		    ...
		    var  r3_11, i3_11 float64
		    var  r3_15, i3_15 float64
		    var  r3_19, i3_19 float64
		    var  r3_23, i3_23 float64
		    var  r3_27, i3_27 float64
		    var  r3_31, i3_31 float64
		    {
			 var  r4_3, i4_3 float64
			 var  r4_11, i4_11 float64
			 var  r4_19, i4_19 float64
			 var  r4_27, i4_27 float64
			 {
			      var  r5_3, i5_3 float64
			      var  r5_19, i5_19 float64
			      r5_3 = c_re(in[3])
			      i5_3 = c_im(in[3])
			      r5_19 = c_re(in[19])
			      i5_19 = c_im(in[19])
			 ...
			 {
			      var  r5_11, i5_11 float64
			      var  r5_27, i5_27 float64
			      r5_11 = c_re(in[11])
			      i5_11 = c_im(in[11])
			      r5_27 = c_re(in[27])
			      i5_27 = c_im(in[27])
		    ...
		    }
		    {
			 var  r4_7, i4_7 float64
			 var  r4_15, i4_15 float64
			 var  r4_23, i4_23 float64
			 var  r4_31, i4_31 float64
			 {
			      var  r5_7, i5_7 float64
			      var  r5_23, i5_23 float64
			      r5_7 = c_re(in[7])
			      i5_7 = c_im(in[7])
			      r5_23 = c_re(in[23])
			      i5_23 = c_im(in[23])
			 ...
			 {
			      var  r5_15, i5_15 float64
			      var  r5_31, i5_31 float64
			      r5_15 = c_re(in[15])
			      i5_15 = c_im(in[15])
			      r5_31 = c_re(in[31])
			      i5_31 = c_im(in[31])
...
func fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_twiddle_32_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
     int l1, i;
     COMPLEX *jp, *kp;
     var  tmpr, tmpi, wr, wi float64
...
func fft_unshuffle_32(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     int i;
     const COMPLEX *ip;
     COMPLEX *jp;
...
func fft_unshuffle_32_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
     const COMPLEX *ip;
     COMPLEX *jp;
     if ((b - a) < 128) {
 ...
 *
 */
func fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW)
{
     int r, m;
     int k;
...
func fft_aux_seq(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW)
{
     int r, m;
     int k;
 ...
 */
func fft(int n, COMPLEX * in, COMPLEX * out)
{
...
func fft_seq(n int, in *complex128, out *complex128)
{
     var factors [40]int		/* allows FFTs up to at least 3^40 */
     int *p = factors;
	 l := 
     W *complex128
...
func test_correctness(n int, out1 *complex128, out2 *complex128) bool {
	
var a,d,error = 0.0 float64
